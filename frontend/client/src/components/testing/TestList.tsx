  ...
  return (
    <div>
      <div className="flex items-center py-3 px-6 border-b border-border bg-muted/30">
        ...
        <div className="flex-1 min-w-[200px] pr-4 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Filename</div>
        <div className="w-48 flex-shrink-0 pr-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Model</div>
