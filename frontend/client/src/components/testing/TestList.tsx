  ...
  return (
    <div>
      <div className="flex items-center py-3 px-6 border-b border-border bg-muted/30">
        ...
        <div className="w-52 flex-shrink-0 pr-4 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Model</div>
        <div className="flex-1 min-w-[180px] text-xs font-semibold text-muted-foreground uppercase tracking-wider">Filename</div>
